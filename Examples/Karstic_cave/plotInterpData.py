...
gs00 = gridspec.GridSpecFromSubplotSpec(2, 1, subplot_spec=gs0[0],hspace=0.25,wspace=0.3)
...
model='gz_result.txt'
#Y=700
Xi1,Zi1,Vi1=interpData.interp_yslice(model,y0=90,
                         start_x=0,stop_x=240,num_x=100,
                         start_z=0,stop_z=220,num_z=100,neighbors=50,kernel='linear')
...
ax1.text(0.01,0.9,"(a) y=90 m",fontsize=fts, transform=ax1.transAxes)

#Y=1450
Xi2,Zi2,Vi2=interpData.interp_xslice(model,x0=120,
                         start_y=0,stop_y=190,num_y=100,
                         start_z=0,stop_z=220,num_z=100,neighbors=50,kernel='linear')
...
ax2.text(0.01,0.9,"(b) x=120 m",fontsize=fts, transform=ax2.transAxes)


#Z=350
Xi3,Yi3,Vi3=interpData.interp_zslice(model,z0=50,
                         start_x=0,stop_x=240,num_x=81,
                         start_y=0,stop_y=190,num_y=81,neighbors=50,kernel='linear')
...
ax3.text(0.01,0.92,"(c) z=100 m",fontsize=fts, transform=ax3.transAxes)
