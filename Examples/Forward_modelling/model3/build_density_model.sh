...
mkdir -p model
makeModel -R 0/2000/0/2000/0/1000 --nx 40 --ny 40 --nz 20 -A anomalies.txt -o model/test_model
...
makeModel -R 0/2000/0/2000/0/1000 --nx 40 --ny 40 --nz 20  -A constraint_geometry.txt -o model/reference.readable
makeModel -R 0/2000/0/2000/0/1000 --nx 40 --ny 40 --nz 20  -A constraint_geometry.txt -o model/cross_gradient_reference.readable

# rearrange the columns of the constraint model to change it into a format required by GraAda3D
awk 'NR>2 {print $7, $8, $9, $10}' model/reference.readable.xyz > model/reference.xyz
awk 'NR>2 {print $7, $8, $9, $10}' model/cross_gradient_reference.readable.xyz > model/cross_gradient_reference.xyz
