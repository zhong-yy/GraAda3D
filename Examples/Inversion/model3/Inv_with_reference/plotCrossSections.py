...
z_id=get_slice_index(xs,400)
z_slice=density[z_id,:,:]

y_id1=get_slice_index(ys,1000)
y_slice1=density[:,y_id1,:]

fig,(ax1,ax2)=plt.subplots(2,1,figsize=(4.5,7),layout='constrained',height_ratios=[1,2])
...
ax1.text(0.01,0.9,"(a) Y=1000 m",fontsize=fts, transform=ax1.transAxes)
...
plt.savefig('Inversion_Slices_ref.jpg',dpi=300,bbox_inches='tight')
