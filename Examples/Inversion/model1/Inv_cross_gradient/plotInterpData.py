...
x,y,z,density=np.loadtxt('gz_result_with_crg.txt',skiprows=2,usecols=[6,7,8,9],unpack=True)
...
model='gz_result_with_crg.txt'
#Y=700
Xi1,Zi1,Vi1=interpData.interp_yslice(model,y0=700,
                         start_x=0,stop_x=2000,num_x=81,
                         start_z=0,stop_z=1000,num_z=41,neighbors=50,kernel='linear')
...
Xi3,Yi3,Vi3=interpData.interp_zslice(model,z0=350,
                         start_x=0,stop_x=2000,num_x=81,
                         start_y=0,stop_y=2000,num_y=81,neighbors=50,kernel='linear')
