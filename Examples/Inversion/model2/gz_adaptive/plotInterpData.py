...
model='gz_result.txt'
#Y=700
Yi1,Zi1,Vi1=interpData.interp_xslice(model,x0=3000,
                         start_y=0,stop_y=6000,num_y=161,
                         start_z=0,stop_z=3500,num_z=71,neighbors=50,kernel='linear')
                         
ax1=fig.add_subplot(gs00[0])
pc=ax1.pcolormesh(Yi1,Zi1,Vi1,cmap=clrmap,vmin=min_value_shown,vmax=max_value_shown,shading='gouraud')
...
ax1.text(0.01,0.9,"(a) X=3000 m",fontsize=fts, transform=ax1.transAxes)

#Y=1450
Xi2,Zi2,Vi2=interpData.interp_yslice(model,y0=3000,
                         start_x=0,stop_x=6000,num_x=161,
                         start_z=0,stop_z=3500,num_z=71,neighbors=50,kernel='linear')
...
ax2.text(0.01,0.9,"(b) Y=3000 m",fontsize=fts, transform=ax2.transAxes)


#Z=350
Xi3,Yi3,Vi3=interpData.interp_zslice(model,z0=1250,
                         start_x=0,stop_x=6000,num_x=161,
                         start_y=0,stop_y=6000,num_y=161,neighbors=100,kernel='linear')
