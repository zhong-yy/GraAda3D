...
x,y,z,density=np.loadtxt('gz_result_L1.txt',skiprows=2,usecols=[6,7,8,9],unpack=True)
...
plt.savefig('Inversion_Slices_interp_L1.jpg',dpi=300,bbox_inches='tight')
