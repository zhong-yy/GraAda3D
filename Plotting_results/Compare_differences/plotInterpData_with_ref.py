...
Xi1,Zi1,Vi1=interpData.interp_yslice(model,y0=700,
                         ...
                         start_z=0,stop_z=1000,num_z=51,neighbors=100,kernel='linear')
...
Xi3,Yi3,Vi3=interpData.interp_zslice(model,z0=350,
                         start_x=0,stop_x=2000,num_x=101,
                         start_y=0,stop_y=2000,num_y=51,neighbors=100,kernel='linear')
...
plt.savefig('Inversion_Slices_interp_with_ref.jpg',dpi=300,bbox_inches='tight')
