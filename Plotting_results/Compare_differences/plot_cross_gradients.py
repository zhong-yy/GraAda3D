...
Xi1,Zi1,slice1_model1=interpData.interp_yslice(model1,y0=700,
                         start_x=0,stop_x=2000,num_x=101,
                         start_z=0,stop_z=1000,num_z=51,neighbors=50,kernel='linear')
...
pc=axs[0,0].pcolormesh(Xi1.T,Zi1.T,slice1_model1.T,cmap=clrmap1,vmin=min_value_shown1,vmax=max_value_shown1,shading='gouraud')
...
pc=axs[0,1].pcolormesh(Xi1.T,Zi1.T,slice1_model2.T,cmap=clrmap1,vmin=min_value_shown2,vmax=max_value_shown2,shading='gouraud')
...
print(Zi1)
print(slice1_model2)
Vi1=cross_gradient(Xi1,Zi1,slice1_model1,slice1_model2)
...
Vi2=cross_gradient(Xi2,Zi2,slice2_model1,slice2_model2)
...
Xi3,Yi3,slice3_model1=interpData.interp_zslice(model1,z0=350,
                         start_x=0,stop_x=2000,num_x=101,
                         start_y=0,stop_y=2000,num_y=101,neighbors=50,kernel='linear')
...
Vi3=cross_gradient(Xi3,Yi3,slice3_model1,slice3_model2)
...
plt.savefig('sim_crg.jpg',dpi=300,bbox_inches='tight')
