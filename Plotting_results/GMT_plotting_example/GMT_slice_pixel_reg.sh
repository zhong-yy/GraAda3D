...
xinc_yinc=100/50
gmt surface cross_section1.txt -R0/2000/0/1000 -I$xinc_yinc -V -Gcross_section1.nc
gmt surface cross_section2.txt -R0/2000/0/1000 -I$xinc_yinc -V -Gcross_section2.nc
...
gmt begin 1pix jpg E300
    ...
    gmt grdimage "${data_file}?density(350)"  -nc -E300 -Q -Cjet
...
gmt begin 2pix jpg E300
    ...
    gmt grdimage cross_section1.nc  -nc -E300 -Q -Cjet
...
gmt begin 3pix jpg E300
    ...
    gmt set MAP_FRAME_PEN 0p,black
    gmt basemap -Jx0.002/-0.002 -R0/2000/0/1000 -Bxa500fg+l"Distance (m)" -Bya500fg+l"Depth (m)" -BWSrt
    gmt grdimage cross_section2.nc  -nc -E300 -Q -Cjet
...
#    gmt grd2cpt "${data_file}?density(350)" cross_section1.nc cross_section2.nc -Crainbow
    ...
    gmt basemap -Jx0.002/-0.002 -R0/2000/0/2000 -Bxa500fg+l"x (m)" -Bya500fg+l"y (m)" -BWSrt
    gmt grdimage "${data_file}?density(350)"  -nc -E300 -Q
    ...
    gmt grdimage cross_section1.nc  -nc -E300 -Q
    ...
    gmt grdimage cross_section2.nc  -nc -E300 -Q
