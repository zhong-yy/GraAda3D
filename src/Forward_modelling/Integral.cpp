...
double Integral::getBeta(const Point& observation, const vector<Point*>& face)
{
	...
	for (int i = 0; i < n; i++) {
		...
		double tt = 0.;
		if (abs(mp)< GS::TOL) { tt = 0.; }
		else if (mp>0) { tt = 1.; }
		else { tt = -1.; }
		if (abs(mj_value) < GS::TOL) { beta += 0.0; }
		else {
...
double Integral::Surface_R1(const Point& observation, const vector<Point*>& face_node, int n)
{
...
double Integral::Surface_R_1(const Point& observation, const vector<Point*>& face_node,int n)
{
	// for(int i=0;i<n;i++){
	// 	cout<<*face_node[i]<<endl;
	// }
	int nn = face_node.size();//node number of the face
	assert(n == nn);
...
Point Integral::Surface_rR1(const Point& observation, const vector<Point*>& face_node, int n)
{
...
Point Integral::Surface_rR_1(const Point& observation, const vector<Point*>& face_node, int n)
{
...
Point Integral::Surface_r2R_1(const Point& observation, const vector<Point*>& face_node, int n)
{
...
double Integral::Surface_xzR_1(const Point& observation, const vector<Point*>& face_node, int n)
{
	double Rds = Surface_R1(observation, face_node, n);
	Point rR_1ds = Surface_rR_1(observation, face_node, n);
	Point unit_normal = unitCross(*face_node[1] - *face_node[0], *face_node[2] - *face_node[1]);
...
double Integral::Surface_yzR_1(const Point& observation, const vector<Point*>& face_node, int n)
{
	double Rds = Surface_R1(observation, face_node, n);
	Point rR_1ds = Surface_rR_1(observation, face_node, n);
	Point unit_normal = unitCross(*face_node[1] - *face_node[0], *face_node[2] - *face_node[1]);
...
double Integral::Surface_xyR_1(const Point& observation, const vector<Point*> &face_node, int n)
{
	double Rds = Surface_R1(observation, face_node, n);
	Point rR_1ds = Surface_rR_1(observation, face_node, n);
	Point unit_normal = unitCross(*face_node[1] - *face_node[0], *face_node[2] - *face_node[1]);
...
double Integral::Surface_R_3(const Point& ob, const vector<Point*>& face_node, int n)
{
	//face_node.push_back(face_node[0]);
	Point unit_normal = unitCross(*face_node[1] - *face_node[0], *face_node[2] - *face_node[1]);
...
Point Integral::Surface_rR_3(const Point& ob, const vector<Point*>& face_node, int n)
{
...
double Integral::Surface_x2R_3(const Point& ob, const vector<Point*>& face_node, int n)
{
...
double Integral::Surface_y2R_3(const Point& ob, const vector<Point*>& face_node, int n)
{
	Point S_rR_3 = Surface_rR_3(ob, face_node, n);
	double S_R_1 = Surface_R_1(ob, face_node, n);
	Point unit_normal = unitCross(*face_node[1] - *face_node[0], *face_node[2] - *face_node[1]);
...
double Integral::Surface_z2R_3(const Point& ob, const vector<Point*>& face_node, int n)
{
	Point S_rR_3 = Surface_rR_3(ob, face_node, n);
	double S_R_1 = Surface_R_1(ob, face_node, n);
	Point unit_normal = unitCross(*face_node[1] - *face_node[0], *face_node[2] - *face_node[1]);
...
double Integral::Surface_xzR_3(const Point& ob, const vector<Point*>& face_node, int n)
{
	Point S_rR_3 = Surface_rR_3(ob, face_node, n);
	double S_R_1 = Surface_R_1(ob, face_node, n);
	Point unit_normal = unitCross(*face_node[1] - *face_node[0], *face_node[2] - *face_node[1]);
...
double Integral::Surface_yzR_3(const Point& ob, const vector<Point*>& face_node, int n)
{
	Point S_rR_3 = Surface_rR_3(ob, face_node, n);
	double S_R_1 = Surface_R_1(ob, face_node, n);
	Point unit_normal = unitCross(*face_node[1] - *face_node[0], *face_node[2] - *face_node[1]);
...
double Integral::Surface_xyR_3(const Point& ob, const vector<Point*>& face_node, int n)
{
	Point S_rR_3 = Surface_rR_3(ob, face_node, n);
	double S_R_1 = Surface_R_1(ob, face_node, n);
	Point unit_normal = unitCross(*face_node[1] - *face_node[0], *face_node[2] - *face_node[1]);
...
void Integral::Surface_r3R_1(const Point& ob, const vector<Point*>& face, int n,
...
void Integral::Surface_f3R_3(const Point& ob, const vector<Point*>& face, int n,
