...
public:
	...
	static double getBeta(const Point& observation, const vector<Point*>& face);
	...
	/***************************************Surface integrals**************************************/
	//calculate the surface integral of R*ds,face_Point is the Points on the face,n is the number of Points
	static double Surface_R1(const Point& observation, const vector<Point*>& face_Point, int n);

	//calculate the surface integral of (1/R)*ds
	static double Surface_R_1(const Point& observation, const vector<Point*>& face_Point, int n);

	/*To calculate the surface integral of (rR)*ds.
	 *Return value is a vector of (integral{xR}ds,integral{yR}ds,integral{zR}ds)
	 */
	static Point Surface_rR1(const Point& observation, const vector<Point*>& face_Point, int n);

	/*To compute the surface integra of (r/R)*ds
	 *Return value is a vector of (integral{x/R}ds,integral{y/R}ds,integral{z/R}ds)
	 */
	static Point Surface_rR_1(const Point& observation, const vector<Point*>& face_Point, int n);
	...
	*/
	static Point Surface_r2R_1(const Point& observation, const vector<Point*>& face_Point, int n);

	/*To compute the surface integral of (xz/R)ds */
	static double Surface_xzR_1(const Point& observation, const vector<Point*>& face_Point, int n);
	/*To compute the surface integral of (yz/R)ds */
	static double Surface_yzR_1(const Point& observation, const vector<Point*>& face_Point, int n);
	/*To compute the surface integral of (xy/R)ds */
	static double Surface_xyR_1(const Point& observation, const vector<Point*>& face_Point, int n);
	
	/*To compute the surface integral of (1/R^3)ds */
	static double Surface_R_3(const Point& ob, const vector<Point*>& face_Point, int n);
	...
	*/
	static Point Surface_rR_3(const Point& ob, const vector<Point*>& face_Point, int n);

	//To compute the surface integral of x2/R^3
	static double Surface_x2R_3(const Point& ob, const vector<Point*>& face_Point, int n);

	//To compute the surface integral of y2/R^3
	static double Surface_y2R_3(const Point& ob, const vector<Point*>& face_Point, int n);

	//To compute the surface integral of z2/R^3
	static double Surface_z2R_3(const Point& ob, const vector<Point*>& face_Point, int n);

	//To compute the surface integral of xz/R^3
	static double Surface_xzR_3(const Point& ob, const vector<Point*>& face_Point, int n);

	//To compute the surface integral of yz/R^3
	static double Surface_yzR_3(const Point& ob, const vector<Point*>& face_Point, int n);

	//To compute the surface integral of xy/R^3
	static double Surface_xyR_3(const Point& ob, const vector<Point*>& face_Point, int n);

	//To compute the surface integral of (xp*xq*xt/R)ds, where xp, xq, xt can be x or y or z.
	static void Surface_r3R_1(const Point& ob, const vector<Point*>& face, int n,
	...
	static void Surface_f3R_3(const Point& ob, const vector<Point*>& face, int n,
