...
int main(int ac, char *av[])
{
    try
    {
        ...
        desc.add_options()
            ...
            ("region,R",po::value<string>(&region), "specify the region of interet. For example, -R 0/4000/0/2000/0/1000 defines a region with x ranging from 0 to 4000, y from 0 to 2000 and z from 0 to 1000.")            
